    ...
    context "signed in user who is an admin" do
      ...
      let(:request) do
        FactoryBot.create(
          ...
          previous_markdown: { "test_part" => { "heading" => "body", "body" => "Old content" } },
          current_markdown: { "test_part" => { "heading" => "body", "body" => "New content" } },
        )
      end
      ...
      describe "GET /compare" do
        ...
        it "renders the respond to fact check button on govspeak tab" do
