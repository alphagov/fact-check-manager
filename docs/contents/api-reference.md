...
| draft_auth_bypass_id | uuid     | Used for when a draft should be linkable without requiring login to signon | Optional                                        |
...
| draft_auth_bypass_id | Used for when a draft should be linkable without requiring login to signon | Optional                              |
